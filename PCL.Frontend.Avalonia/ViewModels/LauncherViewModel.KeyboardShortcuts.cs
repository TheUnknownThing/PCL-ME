...
internal sealed partial class LauncherViewModel
{
    internal bool TryHandleTopLevelNavigationShortcut(Key key)
    {
        ...
        var title = LauncherLocalizationService.ResolveRouteLabel(targetRoute, _i18n);
        NavigateTo(
            targetRoute,
            LauncherLocalizationService.DescribeNavigationActivity(title, "keyboard_shortcut", _i18n),
