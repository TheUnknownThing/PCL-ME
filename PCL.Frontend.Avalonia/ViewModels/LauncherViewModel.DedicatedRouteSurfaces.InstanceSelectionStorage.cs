...
internal sealed partial class LauncherViewModel
{
    ...
    private void PersistInstanceSelectionFolders(
        ...
        FrontendRuntimePaths runtimePaths)
    {
        _launcherActionService.PersistSharedValue("LaunchFolders", SerializeInstanceSelectionFolders(folders, runtimePaths));
        _launcherActionService.RemoveLocalValues(["LaunchFolders"]);
    }
