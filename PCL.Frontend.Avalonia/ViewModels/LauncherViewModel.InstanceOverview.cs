...
internal sealed partial class LauncherViewModel
{
    ...
    {
        if (!IsCurrentStandardRightPane(StandardRightPaneKind.InstanceOverview))
        {
            return;
        }
    ...
    private void ToggleInstanceFavorite()
    {
        ...
        _launcherActionService.PersistInstanceValue(_instanceComposition.Selection.InstanceDirectory, "IsStar", _isInstanceOverviewStarred);
    ...
    private async Task RenameInstanceAsync()
    {
        ...
        var newName = await _launcherActionService.PromptForTextAsync(
        ...
        try
        {
            ...
            _launcherActionService.PersistLocalValue("LaunchInstanceSelect", newName);
            ReloadInstanceComposition();
            AddActivity(
                activityTitle,
    ...
    private async Task EditInstanceDescriptionAsync()
    {
        ...
        var nextValue = await _launcherActionService.PromptForTextAsync(
        ...
        try
        {
            ...
            {
                _launcherActionService.RemoveInstanceValues(instanceDirectory, ["VersionArgumentInfo", "CustomInfo"]);
            }
            else
            {
                _launcherActionService.PersistInstanceValue(instanceDirectory, "VersionArgumentInfo", trimmedValue);
                _launcherActionService.PersistInstanceValue(instanceDirectory, "CustomInfo", trimmedValue);
            }
    ...
    private void ExportInstanceScript()
    {
        ...
        {
            RefreshLaunchState();
            var extension = _launcherActionService.GetCommandScriptExtension();
            ...
            File.WriteAllText(
                ...
                encoding);
            _launcherActionService.EnsureFileExecutable(scriptPath);
    ...
    private void CreateDirectLaunchShortcut()
    {
        ...
        try
        {
            var shortcutPath = _launcherActionService.CreateDirectLaunchShortcut(
                _instanceComposition.Selection.InstanceName,
    ...
    private async Task PatchInstanceCoreAsync()
    {
        ...
        try
        {
            patchPath = await _launcherActionService.PickOpenFileAsync(
        ...
        try
        {
            ...
            _launcherActionService.PersistInstanceValue(_instanceComposition.Selection.InstanceDirectory, "VersionAdvanceAssetsV2", true);
            ReloadInstanceComposition();
    ...
    {
        return Path.Combine(
            _launcherActionService.RuntimePaths.FrontendArtifactDirectory,
            "instance-overview",
            folderName,
