...
internal sealed partial class LauncherViewModel
{
    ...
    {
        return Path.Combine(_launcherActionService.RuntimePaths.DataDirectory, "Pictures");
    }

    private string GetLogoImagePath()
    {
        return Path.Combine(_launcherActionService.RuntimePaths.DataDirectory, "Logo.png");
    }

    private string GetHomepageTutorialPath()
    {
        return Path.Combine(_launcherActionService.RuntimePaths.DataDirectory, "Custom.xaml");
    }
