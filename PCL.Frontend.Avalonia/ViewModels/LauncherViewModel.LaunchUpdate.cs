...
internal sealed partial class LauncherViewModel
{
    ...
    {
        var sharedConfig = _launcherActionService.RuntimePaths.OpenSharedConfigProvider();
        var localConfig = _launcherActionService.RuntimePaths.OpenLocalConfigProvider();
