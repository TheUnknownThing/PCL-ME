...
internal sealed partial class LauncherViewModel
{
    ...
    public string BackTooltip => T("shell.navigation.utilities.back");

    public string HomeTooltip => T("shell.navigation.utilities.home");

    public string TaskManagerTooltip => T("shell.navigation.utilities.task_manager");
    ...
    private void RaiseSectionAI18nProperties()
    {
        ...
        RaisePropertyChanged(nameof(BackTooltip));
        RaisePropertyChanged(nameof(HomeTooltip));
        RaisePropertyChanged(nameof(TaskManagerTooltip));
    }
}
