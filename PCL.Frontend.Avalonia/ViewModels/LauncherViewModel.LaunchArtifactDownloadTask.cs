...
internal sealed class FrontendManagedLaunchArtifactDownloadTask(
    II18nService i18n,
    string title,
    Func<Action<LauncherActionService.FrontendLaunchArtifactProgressSnapshot>, CancellationToken, Task> executeAsync)
    : ITask, ITaskProgressive, ITaskProgressStatus, ITaskCancelable
{
    ...
    private void ReportProgress(LauncherActionService.FrontendLaunchArtifactProgressSnapshot snapshot)
    {
