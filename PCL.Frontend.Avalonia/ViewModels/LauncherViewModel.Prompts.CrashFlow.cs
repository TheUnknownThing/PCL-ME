...
internal sealed partial class LauncherViewModel
{
    ...
    {
        var logPath = _launcherActionService.MaterializeCrashLog(_activeCrashPlan);
    ...
    {
        var exportResult = _launcherActionService.ExportCrashReport(_activeCrashPlan);
    ...
    private CrashAvaloniaPlan BuildCrashPlanForLaunchFailure(FrontendLaunchStartResult startResult)
    {
        var exportRequest = new MinecraftCrashExportPlanRequest(
            ...
            ReportDirectory: Path.Combine(
                _launcherActionService.RuntimePaths.FrontendTempDirectory,
                "CrashReport",
            ...
            CurrentLauncherLogFilePath: _launcherActionService.RuntimePaths.ResolveCurrentLauncherLogFilePath(),
