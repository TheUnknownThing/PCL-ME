...
internal enum StandardLeftPaneKind
{
    None = 0,
    Sidebar = 1,
    InstanceSelection = 4,
...
internal enum StandardRightPaneKind
{
    SetupLaunch = 0,
    SetupLink = 1,
    SetupAbout = 2,
...
internal enum StandardRightPaneGroup
{
    SetupFamily = 0,
    DownloadInstall = 1,
    DownloadCatalog = 2,
...
internal sealed record StandardLeftPaneDescriptor(
    StandardLeftPaneKind Kind,
    string Key);

internal sealed record StandardRightPaneDescriptor(
    StandardRightPaneKind Kind,
    StandardRightPaneGroup Group,
    string Key,
    bool UsesCompatibilityView);

internal sealed record StandardPaneResolution(
    LauncherFrontendRoute Route,
    StandardLeftPaneDescriptor? LeftPane,
    StandardRightPaneDescriptor? RightPane);
