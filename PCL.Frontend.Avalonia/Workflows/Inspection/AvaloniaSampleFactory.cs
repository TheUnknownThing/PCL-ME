...
internal static class AvaloniaSampleFactory
{
    public static StartupAvaloniaInputs CreateDefaultStartupInputs()
    {
    ...
    public static StartupAvaloniaPlan BuildStartupPlan(StartupAvaloniaInputs inputs)
    {
        ...
        return new StartupAvaloniaPlan(startupPlan, consent);
    }

    public static StartupAvaloniaPlan BuildStartupPlan()
    {
        return BuildStartupPlan(CreateDefaultStartupInputs());
    }

    public static ShellAvaloniaInputs CreateDefaultShellInputs()
    {
    ...
    public static LauncherFrontendShellPlan BuildShellPlan(ShellAvaloniaInputs inputs)
    {
    ...
    public static LaunchAvaloniaInputs CreateDefaultLaunchInputs(string scenario)
    {
        return new LaunchAvaloniaInputs(
            Scenario: scenario,
    ...
    public static LaunchAvaloniaPlan BuildLaunchPlan(LaunchAvaloniaInputs inputs, string? saveBatchPath = null)
    {
        var loginPlan = AvaloniaLaunchLoginFactory.BuildPlan(inputs.LoginInputs);
    ...
    public static LaunchAvaloniaPlan BuildLaunchPlan(string scenario, string? saveBatchPath = null)
    {
        return BuildLaunchPlan(CreateDefaultLaunchInputs(scenario), saveBatchPath);
    }

    public static CrashAvaloniaInputs CreateDefaultCrashInputs()
    {
    ...
    public static CrashAvaloniaPlan BuildCrashPlan(CrashAvaloniaInputs inputs)
    {
    ...
    public static CrashAvaloniaPlan BuildCrashPlan()
    {
    ...
    private static LaunchLoginAvaloniaInputs BuildLoginInputs(string scenario)
    {
        return scenario switch
        {
            "legacy-forge" => new LaunchLoginAvaloniaInputs(
                LaunchLoginProviderKind.Authlib,
                Microsoft: null,
                Authlib: new AuthlibLaunchLoginAvaloniaInputs(
                    ...
                    """)),
            _ => new LaunchLoginAvaloniaInputs(
                LaunchLoginProviderKind.Microsoft,
                Microsoft: new MicrosoftLaunchLoginAvaloniaInputs(
    ...
    private static JavaRuntimeAvaloniaInputs BuildJavaRuntimeInputs(string scenario)
    {
        ...
        return new JavaRuntimeAvaloniaInputs(
