...
internal static class AvaloniaExecutor
{
    public static ShellAvaloniaExecution ExecuteShell(LauncherFrontendShellPlan plan, string workspaceRoot)
    {
        Directory.CreateDirectory(workspaceRoot);

        var artifacts = new List<AvaloniaExecutionArtifact>();
        ...
        artifacts.Add(new AvaloniaExecutionArtifact("Frontend prompts", promptsPath));
        ...
        artifacts.Add(new AvaloniaExecutionArtifact("Page surface", surfacePath));
        ...
        artifacts.Add(new AvaloniaExecutionArtifact("Navigation view", navigationPath));
        ...
        artifacts.Add(new AvaloniaExecutionArtifact("Navigation catalog", catalogPath));
        writtenFiles.Add(catalogPath);

        return new ShellAvaloniaExecution(
            new AvaloniaExecutionSummary(
                workspaceRoot,
                [workspaceRoot, Path.Combine(workspaceRoot, "_artifacts")],
                writtenFiles,
                [],
                artifacts),
            new AvaloniaTranscript(
    ...
    public static StartupAvaloniaExecution ExecuteStartup(StartupAvaloniaPlan plan, string workspaceRoot)
    {
        Directory.CreateDirectory(workspaceRoot);
        ...
        artifacts.Add(new AvaloniaExecutionArtifact("Loaded config keys", configKeyPath));
        ...
        artifacts.Add(new AvaloniaExecutionArtifact("Startup prompts", consentPath));
        ...
        return new StartupAvaloniaExecution(
            new AvaloniaExecutionSummary(
                workspaceRoot,
                createdDirectories,
                writtenFiles,
                deletedFiles,
                artifacts),
            new AvaloniaTranscript("Startup Shell Execution", sections));
    }

    public static LaunchAvaloniaExecution ExecuteLaunch(
        ...
        AvaloniaJavaDownloadSessionState javaDownloadState)
    {
        ...
        for (var index = 0; index < plan.LoginPlan.Steps.Count; index++)
        {
            ...
            if (!string.IsNullOrWhiteSpace(step.Method) && !string.IsNullOrWhiteSpace(step.Url))
            {
                ...
                artifacts.Add(new AvaloniaExecutionArtifact($"{step.Title} request", requestSummaryPath));
            ...
            if (!string.IsNullOrWhiteSpace(step.ResponseBody))
            {
                ...
                artifacts.Add(new AvaloniaExecutionArtifact($"{step.Title} response", responsePath));
            ...
            if (step.Notes.Count > 0)
            {
                ...
                artifacts.Add(new AvaloniaExecutionArtifact($"{step.Title} notes", notesPath));
            }
        }
        ...
        sections.Add(new AvaloniaTranscriptSection("Login Execution", loginLines));
        ...
        if (promptOutcome.ActionKind == MinecraftLaunchJavaPromptActionKind.AbortLaunch)
        {
            ...
            return new LaunchAvaloniaExecution(
                javaPromptDecision,
                new AvaloniaExecutionSummary(workspaceRoot, createdDirectories, writtenFiles, [], artifacts),
                new AvaloniaTranscript($"Launch Shell Execution ({plan.Scenario})", sections));
        }
            ...
            plan.JavaRuntimeTransferPlan is not null)
        {
            ...
            artifacts.Add(new AvaloniaExecutionArtifact("Java index request", javaIndexRequestPath));
            ...
            artifacts.Add(new AvaloniaExecutionArtifact("Java manifest request", javaManifestRequestPath));
            ...
            artifacts.Add(new AvaloniaExecutionArtifact("Java download plan", javaDownloadPlanPath));
            ...
            artifacts.Add(new AvaloniaExecutionArtifact("Java transfer plan", javaTransferPlanPath));
            ...
            artifacts.Add(new AvaloniaExecutionArtifact("Java download session", javaSessionPath));
        ...
        if (plan.PrerunPlan.LauncherProfiles.Path is not null)
        {
            ...
            artifacts.Add(new AvaloniaExecutionArtifact("launcher_profiles.json", launcherProfilesPath));
        }
        ...
        artifacts.Add(new AvaloniaExecutionArtifact("options.txt", optionsPath));
        ...
        if (plan.ScriptExportPlan is not null)
        {
            ...
            artifacts.Add(new AvaloniaExecutionArtifact("Exported launch script", resolvedScriptExportPath));
            ...
            artifacts.Add(new AvaloniaExecutionArtifact("Launch script export", scriptExportRecordPath));
            ...
            return new LaunchAvaloniaExecution(
                javaPromptDecision,
                new AvaloniaExecutionSummary(workspaceRoot, DistinctPaths(createdDirectories), writtenFiles, [], artifacts),
                new AvaloniaTranscript($"Launch Shell Execution ({plan.Scenario})", sections));
        }
        ...
        artifacts.Add(new AvaloniaExecutionArtifact("Launch script", launchScriptPath));
        ...
        artifacts.Add(new AvaloniaExecutionArtifact("Startup summary log", startupSummaryPath));
        ...
        artifacts.Add(new AvaloniaExecutionArtifact("Process command summary", processCommandPath));
    ...
    public static CrashAvaloniaExecution ExecuteCrash(
        ...
        string? exportArchivePath)
    {
        ...
        if (response.Kind != MinecraftCrashPromptResponseKind.ExportReport)
        {
            ...
            return new CrashAvaloniaExecution(
                selectedAction,
                new AvaloniaExecutionSummary(workspaceRoot, createdDirectories, writtenFiles, [], artifacts),
                archivedFileNames,
                new AvaloniaTranscript("Crash Shell Execution", sections));
        }
        ...
        artifacts.Add(new AvaloniaExecutionArtifact("Crash archive", archiveResult.ArchiveFilePath));
        ...
        artifacts.Add(new AvaloniaExecutionArtifact("Crash export target", pickerDecisionPath));
    ...
    private static string BuildLoginRequestText(LaunchLoginAvaloniaStepPlan step)
    {
        var builder = new StringBuilder();
    ...
    private static string BuildJavaDownloadSessionText(
        AvaloniaJavaDownloadSessionState state,
