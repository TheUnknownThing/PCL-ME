...
internal static class AvaloniaLaunchLoginFactory
{
    public static LaunchLoginAvaloniaPlan BuildPlan(LaunchLoginAvaloniaInputs inputs)
    {
    ...
    private static LaunchLoginAvaloniaPlan BuildMicrosoftPlan(MicrosoftLaunchLoginAvaloniaInputs inputs)
    {
        ...
        {
            return new LaunchLoginAvaloniaPlan(
                LaunchLoginProviderKind.Microsoft,
                [
                    new LaunchLoginAvaloniaStepPlan(
        ...
        var steps = new List<LaunchLoginAvaloniaStepPlan>();
        ...
        steps.Add(new LaunchLoginAvaloniaStepPlan(
    ...
    private static LaunchLoginAvaloniaPlan BuildAuthlibPlan(AuthlibLaunchLoginAvaloniaInputs inputs)
    {
        ...
        if (authenticatePlan.Kind == MinecraftLaunchAuthProfileSelectionKind.PromptForSelection)
        {
            ...
            selectionNotes.Add($"Avalonia auto-selected prompt option: {selectedProfile.Name}");
        }
