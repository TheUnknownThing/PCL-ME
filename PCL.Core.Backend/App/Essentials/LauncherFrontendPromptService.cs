...
public static class LauncherFrontendPromptService
{
        ...
        MinecraftLaunchJavaPrompt? missingJavaPrompt)
    {
        ...
        if (javaCompatibilityPrompt is not null)
        {
            prompts.Add(FromLaunchPrompt(
                "launch-java-compatibility",
                LauncherFrontendPromptSource.LaunchJavaCompatibility,
                javaCompatibilityPrompt));
        }
