    ...
    public void ResolveMicrosoftProfileMutationReturnsSelectedUpdateForExistingProfile()
    {
        var result = MinecraftLaunchLoginProfileWorkflowService.ResolveMicrosoftProfileMutation(
            new MinecraftLaunchMicrosoftProfileMutationRequest(
                ...
                Profiles:
                [
                    new MinecraftLaunchStoredProfile(MinecraftLaunchStoredProfileKind.Offline, "uuid-offline", "Offline", null, null, null, null, null, null, null, null),
                    new MinecraftLaunchStoredProfile(MinecraftLaunchStoredProfileKind.Microsoft, "uuid-3", "Player", null, null, "old", "old-refresh", null, null, null, "old-raw")
                ],
                ResultUuid: "uuid-3",
                ResultUsername: "Player",
                AccessToken: "new-token",
