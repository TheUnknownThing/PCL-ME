...
internal static class SpikeHostInputFactory
{
    public static StartupSpikeInputs CreateStartupInputs()
    {
    ...
    public static CrashSpikeInputs CreateCrashInputs()
    {
        var sample = SpikeSampleFactory.CreateDefaultCrashInputs();
        var homeDirectory = GetUserHomeDirectory();
        var minecraftRoot = GetMinecraftRootDirectory(homeDirectory);
