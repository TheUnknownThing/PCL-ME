...
lang: zh-TW
permalink: /zh-tw/
description: PCL-ME 是從 PCL-CE 衍生出來的多平台版本，現階段以 C#、.NET 10 與 Avalonia 為主線。
---
...
- [貢獻指南](https://github.com/TheUnknownThing/PCL-CE/blob/dev/CONTRIBUTING.md)
- [Avalonia 前端文件](https://github.com/TheUnknownThing/PCL-CE/blob/dev/PCL.Frontend.Avalonia/README.md)
- [GitHub 倉庫](https://github.com/TheUnknownThing/PCL-CE)
...
- `其他獨立邏輯` 使用 [Apache License 2.0](https://github.com/TheUnknownThing/PCL-CE/blob/dev/LICENSE)。

## 相關文件

- [簡體中文 README](https://github.com/TheUnknownThing/PCL-CE/blob/dev/README.md)
